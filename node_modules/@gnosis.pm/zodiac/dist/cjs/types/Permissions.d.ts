...
export interface PermissionsInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "keyForCompValues", values: [string, BytesLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "keyForFunctions", values: [string, BytesLike]): string;
...
export interface Permissions extends BaseContract {
    ...
    functions: {
        keyForCompValues(targetAddress: string, functionSig: BytesLike, index: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        keyForFunctions(targetAddress: string, functionSig: BytesLike, overrides?: CallOverrides): Promise<[string]>;
    };
    keyForCompValues(targetAddress: string, functionSig: BytesLike, index: BigNumberish, overrides?: CallOverrides): Promise<string>;
    keyForFunctions(targetAddress: string, functionSig: BytesLike, overrides?: CallOverrides): Promise<string>;
    callStatic: {
    ...
    estimateGas: {
        keyForCompValues(targetAddress: string, functionSig: BytesLike, index: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        keyForFunctions(targetAddress: string, functionSig: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        keyForCompValues(targetAddress: string, functionSig: BytesLike, index: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        keyForFunctions(targetAddress: string, functionSig: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
