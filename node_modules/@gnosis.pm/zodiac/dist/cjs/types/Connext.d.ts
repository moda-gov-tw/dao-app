...
export interface ConnextInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "setOrigin", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "setOriginSender", values: [string]): string;
...
export interface Connext extends BaseContract {
    ...
    functions: {
        ...
        setOrigin(_origin: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setOriginSender(_originSender: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        xReceive(arg0: BytesLike, _amount: BigNumberish, _asset: string, _originSender: string, _origin: BigNumberish, _callData: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    avatar(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        setOrigin(_origin: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setOriginSender(_originSender: string, overrides?: CallOverrides): Promise<void>;
        ...
        xReceive(arg0: BytesLike, _amount: BigNumberish, _asset: string, _originSender: string, _origin: BigNumberish, _callData: BytesLike, overrides?: CallOverrides): Promise<string>;
    };
    filters: {
