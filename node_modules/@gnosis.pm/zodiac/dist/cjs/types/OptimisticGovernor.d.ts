...
export interface OptimisticGovernorInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "setCollateralAndBond", values: [string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setEscalationManager", values: [string]): string;
    ...
    events: {
        ...
        "TransactionsProposed(address,uint256,bytes32,((address,uint8,uint256,bytes)[],uint256),bytes32,bytes,string,uint256)": EventFragment;
    };
...
export interface OptimisticGovernor extends BaseContract {
    ...
    functions: {
        ...
        assertionDisputedCallback(assertionId: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        assertionIds(arg0: BytesLike, overrides?: CallOverrides): Promise<[string]>;
        assertionResolvedCallback(assertionId: BytesLike, assertedTruthfully: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        avatar(overrides?: CallOverrides): Promise<[string]>;
        bondAmount(overrides?: CallOverrides): Promise<[BigNumber]>;
        collateral(overrides?: CallOverrides): Promise<[string]>;
        deleteProposalOnUpgrade(proposalHash: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        proposeTransactions(transactions: OptimisticGovernor.TransactionStruct[], explanation: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        setCollateralAndBond(_collateral: string, _bondAmount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setEscalationManager(_escalationManager: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setGuard(_guard: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setIdentifier(_identifier: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setLiveness(_liveness: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setRules(_rules: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setTarget(_target: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setUp(initializeParams: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        PROPOSAL_HASH_KEY(overrides?: CallOverrides): Promise<string>;
        RULES_KEY(overrides?: CallOverrides): Promise<string>;
        assertionDisputedCallback(assertionId: BytesLike, overrides?: CallOverrides): Promise<void>;
        assertionIds(arg0: BytesLike, overrides?: CallOverrides): Promise<string>;
        assertionResolvedCallback(assertionId: BytesLike, assertedTruthfully: boolean, overrides?: CallOverrides): Promise<void>;
        avatar(overrides?: CallOverrides): Promise<string>;
        bondAmount(overrides?: CallOverrides): Promise<BigNumber>;
        collateral(overrides?: CallOverrides): Promise<string>;
        deleteProposalOnUpgrade(proposalHash: BytesLike, overrides?: CallOverrides): Promise<void>;
        escalationManager(overrides?: CallOverrides): Promise<string>;
        ...
        owner(overrides?: CallOverrides): Promise<string>;
        proposalHashes(arg0: BytesLike, overrides?: CallOverrides): Promise<string>;
        proposeTransactions(transactions: OptimisticGovernor.TransactionStruct[], explanation: BytesLike, overrides?: CallOverrides): Promise<void>;
        renounceOwnership(overrides?: CallOverrides): Promise<void>;
        rules(overrides?: CallOverrides): Promise<string>;
        setAvatar(_avatar: string, overrides?: CallOverrides): Promise<void>;
        setCollateralAndBond(_collateral: string, _bondAmount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setEscalationManager(_escalationManager: string, overrides?: CallOverrides): Promise<void>;
        ...
        setLiveness(_liveness: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setRules(_rules: string, overrides?: CallOverrides): Promise<void>;
        setTarget(_target: string, overrides?: CallOverrides): Promise<void>;
        setUp(initializeParams: BytesLike, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "OptimisticGovernorDeployed(address,address,address)"(owner?: string | null, avatar?: string | null, target?: null): OptimisticGovernorDeployedEventFilter;
        OptimisticGovernorDeployed(owner?: string | null, avatar?: string | null, target?: null): OptimisticGovernorDeployedEventFilter;
        "OptimisticOracleChanged(address)"(newOptimisticOracleV3?: string | null): OptimisticOracleChangedEventFilter;
        OptimisticOracleChanged(newOptimisticOracleV3?: string | null): OptimisticOracleChangedEventFilter;
        "OwnershipTransferred(address,address)"(previousOwner?: string | null, newOwner?: string | null): OwnershipTransferredEventFilter;
        OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): OwnershipTransferredEventFilter;
        "ProposalDeleted(bytes32,bytes32)"(proposalHash?: BytesLike | null, assertionId?: BytesLike | null): ProposalDeletedEventFilter;
        ProposalDeleted(proposalHash?: BytesLike | null, assertionId?: BytesLike | null): ProposalDeletedEventFilter;
        "ProposalExecuted(bytes32,bytes32)"(proposalHash?: BytesLike | null, assertionId?: BytesLike | null): ProposalExecutedEventFilter;
        ProposalExecuted(proposalHash?: BytesLike | null, assertionId?: BytesLike | null): ProposalExecutedEventFilter;
        "SetCollateralAndBond(address,uint256)"(collateral?: string | null, bondAmount?: BigNumberish | null): SetCollateralAndBondEventFilter;
        SetCollateralAndBond(collateral?: string | null, bondAmount?: BigNumberish | null): SetCollateralAndBondEventFilter;
        "SetEscalationManager(address)"(escalationManager?: string | null): SetEscalationManagerEventFilter;
        SetEscalationManager(escalationManager?: string | null): SetEscalationManagerEventFilter;
        "SetIdentifier(bytes32)"(identifier?: BytesLike | null): SetIdentifierEventFilter;
        SetIdentifier(identifier?: BytesLike | null): SetIdentifierEventFilter;
        "SetLiveness(uint64)"(liveness?: BigNumberish | null): SetLivenessEventFilter;
        SetLiveness(liveness?: BigNumberish | null): SetLivenessEventFilter;
        ...
        "TransactionExecuted(bytes32,bytes32,uint256)"(proposalHash?: BytesLike | null, assertionId?: BytesLike | null, transactionIndex?: BigNumberish | null): TransactionExecutedEventFilter;
        TransactionExecuted(proposalHash?: BytesLike | null, assertionId?: BytesLike | null, transactionIndex?: BigNumberish | null): TransactionExecutedEventFilter;
        "TransactionsProposed(address,uint256,bytes32,((address,uint8,uint256,bytes)[],uint256),bytes32,bytes,string,uint256)"(proposer?: string | null, proposalTime?: BigNumberish | null, assertionId?: BytesLike | null, proposal?: null, proposalHash?: null, explanation?: null, rules?: null, challengeWindowEnds?: null): TransactionsProposedEventFilter;
        TransactionsProposed(proposer?: string | null, proposalTime?: BigNumberish | null, assertionId?: BytesLike | null, proposal?: null, proposalHash?: null, explanation?: null, rules?: null, challengeWindowEnds?: null): TransactionsProposedEventFilter;
    };
    estimateGas: {
        ...
        assertionIds(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        assertionResolvedCallback(assertionId: BytesLike, assertedTruthfully: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        ...
        proposalHashes(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        proposeTransactions(transactions: OptimisticGovernor.TransactionStruct[], explanation: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        renounceOwnership(overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        assertionIds(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        assertionResolvedCallback(assertionId: BytesLike, assertedTruthfully: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        ...
        proposalHashes(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        proposeTransactions(transactions: OptimisticGovernor.TransactionStruct[], explanation: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        renounceOwnership(overrides?: Overrides & {
