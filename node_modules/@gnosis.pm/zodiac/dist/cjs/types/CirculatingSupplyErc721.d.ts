...
export interface CirculatingSupplyErc721Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getExclusionsPaginated", values: [string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "isExcluded", values: [string]): string;
    encodeFunctionData(functionFragment: "owner", values?: undefined): string;
    encodeFunctionData(functionFragment: "removeExclusion", values: [string, string]): string;
...
export interface CirculatingSupplyErc721 extends BaseContract {
    ...
    functions: {
        exclude(exclusion: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        get(overrides?: CallOverrides): Promise<[BigNumber] & {
            circulatingSupply: BigNumber;
        }>;
        getExclusionsPaginated(start: string, pageSize: BigNumberish, overrides?: CallOverrides): Promise<[string[], string] & {
            array: string[];
            next: string;
        }>;
        isExcluded(_exclusion: string, overrides?: CallOverrides): Promise<[boolean]>;
        owner(overrides?: CallOverrides): Promise<[string]>;
        removeExclusion(prevExclusion: string, exclusion: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        renounceOwnership(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setToken(_token: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        exclude(exclusion: string, overrides?: CallOverrides): Promise<void>;
        get(overrides?: CallOverrides): Promise<BigNumber>;
        getExclusionsPaginated(start: string, pageSize: BigNumberish, overrides?: CallOverrides): Promise<[string[], string] & {
            array: string[];
            next: string;
        ...
        isExcluded(_exclusion: string, overrides?: CallOverrides): Promise<boolean>;
        owner(overrides?: CallOverrides): Promise<string>;
        removeExclusion(prevExclusion: string, exclusion: string, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        "ExclusionAdded(address)"(excludedAddress?: string | null): ExclusionAddedEventFilter;
        ExclusionAdded(excludedAddress?: string | null): ExclusionAddedEventFilter;
        "ExclusionRemoved(address)"(RemovedAddress?: string | null): ExclusionRemovedEventFilter;
        ExclusionRemoved(RemovedAddress?: string | null): ExclusionRemovedEventFilter;
        "OwnershipTransferred(address,address)"(previousOwner?: string | null, newOwner?: string | null): OwnershipTransferredEventFilter;
        OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): OwnershipTransferredEventFilter;
        "TokenSet(address)"(newToken?: string | null): TokenSetEventFilter;
        TokenSet(newToken?: string | null): TokenSetEventFilter;
    };
    estimateGas: {
        exclude(exclusion: string, overrides?: Overrides & {
            from?: string;
        ...
        get(overrides?: CallOverrides): Promise<BigNumber>;
        getExclusionsPaginated(start: string, pageSize: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        isExcluded(_exclusion: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getExclusionsPaginated(start: string, pageSize: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        isExcluded(_exclusion: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
