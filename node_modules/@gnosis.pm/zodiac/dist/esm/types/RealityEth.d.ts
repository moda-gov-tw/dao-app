...
export interface RealityEthInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "addProposalWithNonce", values: [string, BytesLike[], BigNumberish]): string;
    encodeFunctionData(functionFragment: "answerExpiration", values?: undefined): string;
    encodeFunctionData(functionFragment: "avatar", values?: undefined): string;
    encodeFunctionData(functionFragment: "buildQuestion", values: [string, BytesLike[]]): string;
    ...
    encodeFunctionData(functionFragment: "generateTransactionHashData", values: [string, BigNumberish, BytesLike, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "getChainId", values?: undefined): string;
    encodeFunctionData(functionFragment: "getGuard", values?: undefined): string;
    encodeFunctionData(functionFragment: "getQuestionId", values: [string, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "markProposalWithExpiredAnswerAsInvalid", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "questionIds", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "questionTimeout", values?: undefined): string;
    encodeFunctionData(functionFragment: "renounceOwnership", values?: undefined): string;
    encodeFunctionData(functionFragment: "setAnswerExpiration", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "setMinimumBond", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "setQuestionCooldown", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "setQuestionTimeout", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "setTarget", values: [string]): string;
    encodeFunctionData(functionFragment: "setTemplate", values: [BigNumberish]): string;
...
export interface RealityEth extends BaseContract {
    ...
    functions: {
        ...
        addProposal(proposalId: string, txHashes: BytesLike[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        addProposalWithNonce(proposalId: string, txHashes: BytesLike[], nonce: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        answerExpiration(overrides?: CallOverrides): Promise<[number]>;
        avatar(overrides?: CallOverrides): Promise<[string]>;
        buildQuestion(proposalId: string, txHashes: BytesLike[], overrides?: CallOverrides): Promise<[string]>;
        executeProposal(proposalId: string, txHashes: BytesLike[], to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        executeProposalWithIndex(proposalId: string, txHashes: BytesLike[], to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, txIndex: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        executedProposalTransactions(arg0: BytesLike, arg1: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
        generateTransactionHashData(to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, nonce: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        getChainId(overrides?: CallOverrides): Promise<[BigNumber]>;
        getGuard(overrides?: CallOverrides): Promise<[string] & {
            _guard: string;
        }>;
        getQuestionId(question: string, nonce: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        getTransactionHash(to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, nonce: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        guard(overrides?: CallOverrides): Promise<[string]>;
        markProposalAsInvalid(proposalId: string, txHashes: BytesLike[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        markProposalAsInvalidByHash(questionHash: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        markProposalWithExpiredAnswerAsInvalid(questionHash: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        questionIds(arg0: BytesLike, overrides?: CallOverrides): Promise<[string]>;
        questionTimeout(overrides?: CallOverrides): Promise<[number]>;
        renounceOwnership(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setAnswerExpiration(expiration: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setArbitrator(arbitrator: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        setMinimumBond(bond: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setQuestionCooldown(cooldown: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setQuestionTimeout(timeout: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setTarget(_target: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setTemplate(templateId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        INVALIDATED(overrides?: CallOverrides): Promise<string>;
        TRANSACTION_TYPEHASH(overrides?: CallOverrides): Promise<string>;
        addProposal(proposalId: string, txHashes: BytesLike[], overrides?: CallOverrides): Promise<void>;
        addProposalWithNonce(proposalId: string, txHashes: BytesLike[], nonce: BigNumberish, overrides?: CallOverrides): Promise<void>;
        answerExpiration(overrides?: CallOverrides): Promise<number>;
        avatar(overrides?: CallOverrides): Promise<string>;
        buildQuestion(proposalId: string, txHashes: BytesLike[], overrides?: CallOverrides): Promise<string>;
        executeProposal(proposalId: string, txHashes: BytesLike[], to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, overrides?: CallOverrides): Promise<void>;
        executeProposalWithIndex(proposalId: string, txHashes: BytesLike[], to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, txIndex: BigNumberish, overrides?: CallOverrides): Promise<void>;
        executedProposalTransactions(arg0: BytesLike, arg1: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        generateTransactionHashData(to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, nonce: BigNumberish, overrides?: CallOverrides): Promise<string>;
        getChainId(overrides?: CallOverrides): Promise<BigNumber>;
        getGuard(overrides?: CallOverrides): Promise<string>;
        ...
        getTransactionHash(to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, nonce: BigNumberish, overrides?: CallOverrides): Promise<string>;
        guard(overrides?: CallOverrides): Promise<string>;
        markProposalAsInvalid(proposalId: string, txHashes: BytesLike[], overrides?: CallOverrides): Promise<void>;
        markProposalAsInvalidByHash(questionHash: BytesLike, overrides?: CallOverrides): Promise<void>;
        markProposalWithExpiredAnswerAsInvalid(questionHash: BytesLike, overrides?: CallOverrides): Promise<void>;
        minimumBond(overrides?: CallOverrides): Promise<BigNumber>;
        oracle(overrides?: CallOverrides): Promise<string>;
        owner(overrides?: CallOverrides): Promise<string>;
        questionArbitrator(overrides?: CallOverrides): Promise<string>;
        ...
        setAnswerExpiration(expiration: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setArbitrator(arbitrator: string, overrides?: CallOverrides): Promise<void>;
        setAvatar(_avatar: string, overrides?: CallOverrides): Promise<void>;
        setGuard(_guard: string, overrides?: CallOverrides): Promise<void>;
        setMinimumBond(bond: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setQuestionCooldown(cooldown: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setQuestionTimeout(timeout: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setTarget(_target: string, overrides?: CallOverrides): Promise<void>;
        setTemplate(templateId: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "ProposalQuestionCreated(bytes32,string)"(questionId?: BytesLike | null, proposalId?: string | null): ProposalQuestionCreatedEventFilter;
        ProposalQuestionCreated(questionId?: BytesLike | null, proposalId?: string | null): ProposalQuestionCreatedEventFilter;
        "RealityModuleSetup(address,address,address,address)"(initiator?: string | null, owner?: string | null, avatar?: string | null, target?: null): RealityModuleSetupEventFilter;
        RealityModuleSetup(initiator?: string | null, owner?: string | null, avatar?: string | null, target?: null): RealityModuleSetupEventFilter;
    ...
    estimateGas: {
        ...
        buildQuestion(proposalId: string, txHashes: BytesLike[], overrides?: CallOverrides): Promise<BigNumber>;
        executeProposal(proposalId: string, txHashes: BytesLike[], to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        executeProposalWithIndex(proposalId: string, txHashes: BytesLike[], to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, txIndex: BigNumberish, overrides?: Overrides & {
        ...
        generateTransactionHashData(to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, nonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getChainId(overrides?: CallOverrides): Promise<BigNumber>;
        getGuard(overrides?: CallOverrides): Promise<BigNumber>;
        getQuestionId(question: string, nonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getTransactionHash(to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, nonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        questionIds(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        buildQuestion(proposalId: string, txHashes: BytesLike[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
        executeProposal(proposalId: string, txHashes: BytesLike[], to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        executeProposalWithIndex(proposalId: string, txHashes: BytesLike[], to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, txIndex: BigNumberish, overrides?: Overrides & {
        ...
        generateTransactionHashData(to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, nonce: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getChainId(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getGuard(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getQuestionId(question: string, nonce: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getTransactionHash(to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, nonce: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        questionIds(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
