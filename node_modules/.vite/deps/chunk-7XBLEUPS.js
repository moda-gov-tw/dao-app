  ...
  "node_modules/@stablelib/sha256/lib/sha256.js"(exports) {
    ...
    function hashBlocks(w, v, p2, pos, len) {
      while (len >= 64) {
        ...
        for (var i = 0; i < 16; i++) {
          var j2 = pos + i * 4;
          w[i] = binary_1.readUint32BE(p2, j2);
        }
        for (var i = 16; i < 64; i++) {
          var u = w[i - 2];
...
function Un(e, n) {
  const t = ue.sharedKey(fromString2(e, p), fromString2(n, p)), r = new import_hkdf.HKDF(import_sha256.SHA256, t).expand(Q);
...
function jn(e) {
  ...
  const t = typeof e.senderPublicKey < "u" ? fromString2(e.senderPublicKey, p) : void 0, r = typeof e.iv < "u" ? fromString2(e.iv, p) : (0, import_random.randomBytes)(J), o = new import_chacha20poly1305.ChaCha20Poly1305(fromString2(e.symKey, p)).seal(r, fromString2(e.message, x));
  return Ie({ type: n, sealed: o, iv: r, senderPublicKey: t });
}
function Cn(e) {
  const n = new import_chacha20poly1305.ChaCha20Poly1305(fromString2(e.symKey, p)), { sealed: t, iv: r } = Z(e.encoded), o = n.open(r, t);
  if (o === null)
...
function Z(e) {
  const n = fromString2(e, L), t = n.slice(wn, Oe), r = Oe;
  if ($(t) === U) {
...
function Dn(e, n) {
  const t = Z(e);
  return Pe({ type: $(t.type), senderPublicKey: typeof t.senderPublicKey < "u" ? toString2(t.senderPublicKey, p) : void 0, receiverPublicKey: n?.receiverPublicKey });
}
function Pe(e) {
  const n = e?.type || Y;
  if (n === U) {
...
var we = (e, n, t) => n in e ? kn(e, n, { enumerable: true, configurable: true, writable: true, value: t }) : e[n] = t;
var Re = (e, n) => {
  for (var t in n || (n = {}))
    Mn.call(n, t) && we(e, t, n[t]);
  if (Te)
    for (var t of Te(n))
      Kn.call(n, t) && we(e, t, n[t]);
  return e;
};
var Ae = "ReactNative";
...
function De() {
  if (j() === b.reactNative && typeof globalThis < "u" && typeof (globalThis == null ? void 0 : globalThis.Platform) < "u") {
    const { OS: t, Version: r } = globalThis.Platform;
    return [t, r].join("-");
  }
  const e = detect();
  if (e === null)
...
function Ve() {
  var e;
  const n = j();
  return n === b.browser ? [n, ((e = (0, import_window_getters.getLocation)()) == null ? void 0 : e.host) || "unknown"].join(":") : n;
}
function ke(e, n, t) {
  const r = De(), o = Ve();
...
function qn({ protocol: e, version: n, relayUrl: t, sdkVersion: r, auth: o, projectId: s, useOnCloseEvent: i }) {
  const d = t.split("?"), l = ke(e, n, r), c = { auth: o, ua: l, projectId: s, useOnCloseEvent: i || void 0 }, u = Ce(d[1] || "", c);
  return d[0] + "?" + u;
}
function O(e, n) {
...
async function ct({ id: e, topic: n, wcDeepLink: t }) {
  try {
    ...
    i === b.browser ? s.startsWith("https://") ? window.open(s, "_blank", "noreferrer noopener") : window.open(s, "_self", "noreferrer noopener") : i === b.reactNative && typeof (globalThis == null ? void 0 : globalThis.Linking) < "u" && await globalThis.Linking.openURL(s);
  } catch (r) {
    console.error(r);
  }
}
...
var He = (e, n, t) => n in e ? dt(e, n, { enumerable: true, configurable: true, writable: true, value: t }) : e[n] = t;
var pt = (e, n) => {
  for (var t in n || (n = {}))
    lt.call(n, t) && He(e, t, n[t]);
  if (Fe)
    for (var t of Fe(n))
...
function mt(e) {
  ...
  return { protocol: r, topic: Ge(o[0]), version: parseInt(o[1], 10), symKey: i.symKey, relay: qe(i) };
}
function Ge(e) {
...
function re(e) {
  ...
  for (const [s, i] of Object.entries(e)) {
    const d = te(s) ? [s] : i.chains, l = i.methods || [], c = i.events || [], u = Ze(s);
    o[u] = Ot(Nt({}, o[u]), { chains: S(d, (n = o[u]) == null ? void 0 : n.chains), methods: S(l, (t = o[u]) == null ? void 0 : t.methods), events: S(c, (r = o[u]) == null ? void 0 : r.events) });
  }
  return o;
}
...
function wt(e, n) {
  ...
  return O(o, r) ? (r.forEach((i) => {
    ...
    (!O(M(i, a), u) || !O(a.methods, l) || !O(a.events, c)) && (s = false);
  }), s) : false;
}
function D(e) {
  return y(e, false) && e.includes(":") ? e.split(":").length === 2 : false;
}
function Xe(e) {
  if (y(e, false) && e.includes(":")) {
    const n = e.split(":");
    if (n.length === 3) {
      const t = n[0] + ":" + n[1];
      return !!n[2] && D(t);
...
function _t(e, n) {
  let t = null;
  return y(e?.publicKey, false) || (t = N("MISSING_OR_INVALID", `${n} controller public key should be a string`)), t;
}
function oe(e) {
  let n = true;
  return C(e) ? e.length && (n = e.every((t) => y(t, false))) : n = false, n;
}
function en(e, n, t) {
  let r = null;
...
function Vt(e) {
  return !(!e || typeof e != "object" || !e.code || !q(e.code, false) || !e.message || !y(e.message, false));
}
function kt(e) {
  return !(I(e) || !y(e.method, false));
}
function Mt(e) {
  return !(I(e) || I(e.result) && I(e.error) || !q(e.id, false) || !y(e.jsonrpc, false));
}
function Kt(e) {
  return !(I(e) || !y(e.name, false));
}
function Lt(e, n) {
  return !(!D(n) || !Ye(e).includes(n));
}
function xt(e, n, t) {
  return y(t, false) ? Je(e, n).includes(t) : false;
}
function Ft(e, n, t) {
  return y(t, false) ? Qe(e, n).includes(t) : false;
}
function an(e, n, t) {
  let r = null;
...
//# sourceMappingURL=chunk-7XBLEUPS.js.map
