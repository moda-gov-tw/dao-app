...
const createUpdaterFn = option => newOptions => oldOptions => newOptions[option] ? Object.assign(Object.assign({}, oldOptions), {
  [option]: newOptions[option]
}) : oldOptions;
const updateRequired = createUpdaterFn('required');
const updateValidate = createUpdaterFn('validate');
const isRequiredField = (field, requiredFields) => requiredFields[field.id];
const generateRequiredRule = field => {
  const {
    label
  } = field;
...
const handleRequiredField = (field, requiredFields) => isRequiredField(field, requiredFields) ? generateRequiredRule(field) : {};
// VALIDATION UTILS
const allowEmpty = (value, validateFn) => {
  if (!value) {
    return true;
  }
  return validateFn(value);
};
const hasTypeValidation = field => field.expectType !== undefined;
const handleTypeValidation = field => hasTypeValidation(field) ? {
  validate: val => allowEmpty(val, ValidateField[field.expectType])
} : {};
const generateRules = ({
  field,
...
const FormBuilderFactory = ({
  ...
  const GeneratedField = useMemo(() => {
    ...
    return jsx(Field, Object.assign({}, field, {
      rules: newRules,
  ...
  return jsx(Spacer, Object.assign({
    "$fieldSpacing": fieldSpacing
  }, {
    children: GeneratedField
  }));
};
const Spacer = styled.div(_t || (_t = _`
  margin-bottom: ${0};
`), ({
  $fieldSpacing
}) => $fieldSpacing || '0');
...
const FormBaseContext = /*#__PURE__*/React.createContext({
  form: FAKE_FORM,
  requiredFields: {},
  formDisabled: false,
...
const FormBuilderBase = ({
  ...
  return jsxs(FormProvider, Object.assign({}, methods, {
    children: [log && jsx(Logger, {}), devtool && jsx(DevTool, {
      control: control
    }), jsx(FormBaseContext.Provider, Object.assign({
      value: {
        form,
        requiredFields,
      ...
      children: jsxs("form", Object.assign({
        ...
        children: [fields === null || fields === void 0 ? void 0 : fields.map(field => jsx(FormBuilderFactory, {
          field: field
        }, field.id)), footer]
      }))
    }))]
...
export { FormBaseContext, FormBuilderBase, FormBuilderFactory, Logger, createUpdaterFn, generateRequiredRule, generateRules, handleRequiredField, handleTypeValidation, hasTypeValidation, isRequiredField, useFormBuilder };
