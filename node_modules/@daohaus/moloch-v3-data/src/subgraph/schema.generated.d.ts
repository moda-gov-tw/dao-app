...
export type Dao_OrderBy = 'activeMemberCount' | 'adminLocked' | 'baalVersion' | 'createdAt' | 'createdBy' | 'delegatedVaultManager' | 'eventTransactions' | 'existingSafe' | 'existingSharesAndLoot' | 'forwarder' | 'governorLocked' | 'gracePeriod' | 'id' | 'latestSponsoredProposalId' | 'lootAddress' | 'lootPaused' | 'lootTokenName' | 'lootTokenSymbol' | 'managerLocked' | 'members' | 'minRetentionPercent' | 'name' | 'proposalCount' | 'proposalOffering' | 'proposals' | 'quorumPercent' | 'rageQuits' | 'records' | 'referrer' | 'safeAddress' | 'shaman' | 'shareTokenName' | 'shareTokenSymbol' | 'sharesAddress' | 'sharesPaused' | 'sponsorThreshold' | 'totalLoot' | 'totalShares' | 'txHash' | 'vaults' | 'votingPeriod' | 'votingPlusGraceDuration';
...
export type EventTransaction_OrderBy = 'createdAt' | 'dao' | 'daoAddress' | 'id';
...
export type Member_OrderBy = 'createdAt' | 'dao' | 'delegateOf' | 'delegateOfCount' | 'delegateShares' | 'delegatingTo' | 'delegatingToMember' | 'id' | 'lastDelegateUpdateTxHash' | 'loot' | 'memberAddress' | 'shares' | 'sharesLootDelegateShares' | 'txHash' | 'votes';
...
export type Proposal_OrderBy = 'actionFailed' | 'actionGasEstimate' | 'cancelled' | 'cancelledBy' | 'cancelledTxAt' | 'cancelledTxHash' | 'contentURI' | 'contentURIType' | 'createdAt' | 'createdBy' | 'currentlyPassing' | 'dao' | 'description' | 'details' | 'expiration' | 'expirationQueryField' | 'graceEnds' | 'gracePeriod' | 'id' | 'maxTotalSharesAndLootAtYesVote' | 'noBalance' | 'noVotes' | 'passed' | 'prevProposalId' | 'processTxAt' | 'processTxHash' | 'processed' | 'processedBy' | 'proposalData' | 'proposalDataHash' | 'proposalId' | 'proposalOffering' | 'proposalType' | 'proposedBy' | 'proposerMembership' | 'selfSponsor' | 'sponsor' | 'sponsorMembership' | 'sponsorTxAt' | 'sponsorTxHash' | 'sponsored' | 'title' | 'tributeEscrowRecipient' | 'tributeOffered' | 'tributeToken' | 'tributeTokenDecimals' | 'tributeTokenSymbol' | 'txHash' | 'votes' | 'votingEnds' | 'votingPeriod' | 'votingPlusGraceDuration' | 'votingStarts' | 'yesBalance' | 'yesVotes';
...
export type RageQuit_OrderBy = 'createdAt' | 'dao' | 'id' | 'loot' | 'member' | 'shares' | 'to' | 'tokens' | 'txHash';
...
export type Record_OrderBy = 'content' | 'contentType' | 'createdAt' | 'createdBy' | 'dao' | 'id' | 'queryType' | 'table' | 'tag';
...
export type Shaman_OrderBy = 'createdAt' | 'dao' | 'id' | 'permissions' | 'shamanAddress';
...
export type TokenLookup_OrderBy = 'dao' | 'id';
...
export type Vault_OrderBy = 'active' | 'createdAt' | 'dao' | 'id' | 'name' | 'ragequittable' | 'safeAddress';
...
export type Vote_OrderBy = 'approved' | 'balance' | 'createdAt' | 'daoAddress' | 'id' | 'member' | 'proposal' | 'txHash';
