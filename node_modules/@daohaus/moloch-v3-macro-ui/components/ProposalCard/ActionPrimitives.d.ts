...
export declare const ProposalPass: ({ text }: {
    text: string;
}) => JSX.Element;
export declare const ProposalFail: ({ text }: {
    text: string;
}) => JSX.Element;
export declare const Verdict: ({ passed, appendText, }: {
    passed: boolean;
    appendText?: string | undefined;
}) => JSX.Element;
export declare const VoteStatus: ({ passing }: {
    passing: boolean;
}) => JSX.Element;
export declare const VotingResults: ({ isVoting, proposal, }: {
    isVoting: boolean;
    proposal: MolochV3Proposal;
}) => JSX.Element;
export declare const ActionTemplate: ({ helperDisplay, statusDisplay, main, proposal, }: {
    helperDisplay?: string | React.ReactNode;
    statusDisplay?: string | React.ReactNode;
    main?: React.ReactNode;
    proposal: MolochV3Proposal;
}) => JSX.Element;
export declare const GasDisplay: ({ gasAmt, daoChain, }: {
    gasAmt: string | number;
    daoChain: string;
}) => JSX.Element;
export declare const VoteUpButton: import("styled-components").IStyledComponent<"web", {
    rules: (string | true)[];
    ...
    IconLeft?: import("react-icons").IconType | React.FunctionComponent<React.SVGProps<SVGSVGElement>> | undefined;
    IconRight?: import("react-icons").IconType | React.FunctionComponent<React.SVGProps<SVGSVGElement>> | undefined;
...
export declare const VoteDownButton: import("styled-components").IStyledComponent<"web", {
    rules: (string | true)[];
    form?: string | undefined;
    slot?: string | undefined;
    style?: React.CSSProperties | undefined;
...
export declare const VoteBox: import("styled-components").IStyledComponent<"web", {
