...
export type PolymorphicLinkProps<Element extends React.ElementType> = React.PropsWithChildren<NewElementProps<Element>> & Omit<React.ComponentPropsWithoutRef<Element>, keyof NewElementProps<Element>>;
export {};
