...
export declare const StyledButton: import("styled-components").IStyledComponent<"web", import("styled-components/dist/types").Substitute<import("react").DetailedHTMLProps<import("react").ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>, {
    $justify: ButtonJustifyContent;
    $color: ButtonColor;
}>>;
export declare const LoadingAbsolute: import("styled-components").IStyledComponent<"web", {
    size?: number | undefined;
    color?: ButtonColor | undefined;
    margin?: string | undefined;
    padding?: string | undefined;
}>;
export declare const StyledInvisibleSpan: import("styled-components").IStyledComponent<"web", {
