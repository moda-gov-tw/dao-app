...
export declare const ProfileAvatar: ({ address, image, src, ...props }: ProfileAvatarProps) => JSX.Element;
export declare const BlockieImg: import("styled-components").IStyledComponent<"web", {
