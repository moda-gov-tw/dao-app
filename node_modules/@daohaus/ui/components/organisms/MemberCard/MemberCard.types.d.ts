...
import { DropdownContentProps, DropdownItemProps } from '../../molecules/Dropdown/Dropdown.types';
import { ProfileButtonProps } from '../../molecules/ProfileButton/ProfileButton.types';
export type MemberCardProps = Omit<ProfileButtonProps, 'color'> & Omit<DropdownContentProps, 'color'> & {
